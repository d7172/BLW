...
export default function TermsAndConditions() {
  return (
    <>
      <SEO title="Terms & Conditions | BLW" description="Terms and conditions for using BLW logistics services." />
      <div className="pt-40 pb-24 container mx-auto px-6 max-w-3xl prose prose-slate prose-headings:font-serif prose-h1:text-5xl prose-h1:font-bold prose-h2:text-2xl prose-a:text-primary">
        <div className="bg-white p-10 md:p-14 rounded-[3rem] shadow-sm border border-border">
          ...
          <p>By accessing this website and utilizing BLW logistics services, you accept and agree to be bound by these Terms and Conditions.</p>
          
          <h2>2. Service Limitations</h2>
          <p>Transit times provided in quotes are estimates and are not guaranteed. BLW is not liable for delays caused by weather, customs, or other factors beyond our control.</p>
